-- Run this in Supabase SQL Editor to update BOTH tables
...
ADD COLUMN IF NOT EXISTS previous_gross DECIMAL(12, 2) DEFAULT 0;

-- 2. Update salary_slips table
...
ADD COLUMN IF NOT EXISTS leave_encashment DECIMAL(12, 2) DEFAULT 0,
ADD COLUMN IF NOT EXISTS overtime DECIMAL(12, 2) DEFAULT 0,
ADD COLUMN IF NOT EXISTS unpaid_leaves DECIMAL(12, 2) DEFAULT 0;
